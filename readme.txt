...
1. Unzip the picasa-media-library.zip
2. Copy picasa-media-library folder to wp-content/plugins
3. Go to Plugins/Installed Plugins, find Picasa Media Library and click Active
4. Enjoy!

== Screenshots ==

1. "Picasa Media Library" button
1. Get all albums of Picasa user
1. User image with many purposes
1. Enjoy
